        ...
        <div className="animate-fade-in-up space-y-6">
              ...
              <div className="flex items-start gap-4 relative z-10">
                ...
                <div className="flex-1 space-y-1">
                  ...
                  <div className="pt-3 flex gap-2">
                     <span className="px-2 py-1 bg-[#18181b] border border-gray-700 rounded text-xs text-gray-300">Level 42</span>
                     <span className="px-2 py-1 bg-[#18181b] border border-gray-700 rounded text-xs text-gray-300">Joined: 1 Yr Ago</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4 relative z-10">
                <div className="flex justify-between items-center p-3 bg-[#18181b] rounded-lg border border-gray-700/50">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-300 font-medium">Available Diamonds</span>
                  </div>
                  <span className="font-bold text-white text-lg">15,240</span>
                </div>
                ...
                <div className="flex justify-between items-center p-3 bg-[#18181b] rounded-lg border border-gray-700/50">
                  ...
                  <span className="font-bold text-white text-lg">8,450,000</span>
                </div>

                <div className="flex justify-between items-center p-3 bg-[#18181b] rounded-lg border border-gray-700/50">
                  <div className="flex items-center gap-2">
                    <span className="text-green-500 text-lg">💵</span>
                    <span className="text-sm text-gray-300 font-medium">Total Lifetime Earnings</span>
                  </div>
                  <span className="font-bold text-green-400 text-lg">$4,250.00</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[var(--card-bg)] rounded-xl p-6 border border-gray-800 shadow-xl text-center">
            ...
            <p className="text-sm text-gray-300 mb-6 max-w-lg mx-auto">
              By approving this user as an agency, they will gain access to the Agency Dashboard, ability to recruit hosts, and earn agency commissions.
            </p>
            <div className="flex items-center justify-center gap-4">
              ...
              <button className="px-8 py-3 bg-gradient-to-r from-emerald-500 to-green-600 text-white rounded-lg text-sm font-semibold shadow-lg hover:shadow-emerald-500/25 transition-all transform hover:-translate-y-0.5 flex items-center gap-2">
                <svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24">
