      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-[var(--card-bg)] rounded-2xl border border-gray-800 shadow-xl p-8 h-fit">
          ...
          <div className="space-y-5">
            ...
            <button className="w-full py-3 bg-red-600 hover:bg-red-700 text-white rounded-lg text-sm font-semibold shadow transition-colors mt-2">
              Update Password
            </button>
          </div>
        </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="flex gap-2">
                  <input type="text" readOnly value="pk_test_1234567890abcdef" className="w-full bg-[#18181b] border border-gray-700 rounded-lg px-4 py-2 text-gray-400 font-mono text-sm" />
                  <button className="px-4 py-2 bg-[#27272a] hover:bg-gray-700 text-white rounded border border-gray-700">Copy</button>
                </div>
              </div>
              <button className="text-sm text-green-500 hover:text-green-400 font-semibold underline mt-2">Generate New Keys</button>
            </div>
          </div>
        </div>
      </div>
